...
export const RX_PRESETS = {
  ...
  antibioticos: [
    ...
    { label:"Clavulin (amoxi+clav)", text:"Amoxicilina + Clavulanato — posologia conforme apresentação. Orientar conforme avaliação clínica." },
  ...
  antidiabeticos: [
    ...
    { label:"Gliclazida", text:"Gliclazida — posologia conforme apresentação. Ajustar conforme glicemia/hipoglicemia." },
